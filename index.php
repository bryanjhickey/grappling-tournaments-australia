				...
				<div class="row">
					...
					<h3>Victory loves preparation</h3>
						<div class="row">
							...
							<h5>THANKS TO ALL WHO MADE THE EVENT A SUCCESS!</h5>
							<br />
							<h5><a href="http://www.strongvon.com/aujiujitsuchamps2015/m_results5.jsp?id=1862" target="_blank" class="button medium radius">VIEW RESULTS</a></h5>
						</div>
					</div>
