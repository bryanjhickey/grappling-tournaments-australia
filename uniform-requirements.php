...
<title>Uniform requirements | Grappling Tournaments Australia</title>
...
<?php include '_masthead.php'; ?>
	<div class="row">
		<div id="uniformRequirements" class="small-10 small-offset-1 text-content large-12 columns">
			...
			<ol>
				<li>Gi must be constructed of cotton or similar material and in good condition. No torn or dirty kimonos allowed</li>
				<li>Gi color may be black,white, or blue, but no mismatched pant and top color combinations. (eg. white jacket with black pants)</li>
				<li>The jacket skirt must reach the thighs, and sleeves must reach the wrist with arms extended in front of the body.</li>
				<li>Belt width 4-5 centimeters, in the color of the athlete’s current rank, and tied around the waist in a double knot, tight enough to keep the jacket closed.</li>
			...
			<p>Shirt of elastic fabric (clings to body) at a length that covers the shorts’ waist band, of black or white color, and displaying at least 10% of the color of the rank (belt) to which the athlete belongs. Shirts that are 100% the color of the rank (belt) the athlete belongs to are also acceptable.</p>
			<h3 class="subheader">Women:</h3>
			<p>Board shorts or lycra elastic pants primarily black with up to 30% of their rank color (belt), without pockets or with pockets entirely stitched shut, and reaching at least halfway down the thigh and at most to the knee. Attached metal or plastic of any kind that may hurt the opponent is expressly forbidden on the board shorts.</p>
			<p>Shirt of elastic fabric (clings to body) at a length that covers the shorts’ waist band, of black or white color, and displaying at least 10% of the color of the rank (belt) to which the athlete belongs. Shirts that are 100% the color of the rank (belt) the athlete belongs to are also acceptable.</p>
		</div>
	</div>
